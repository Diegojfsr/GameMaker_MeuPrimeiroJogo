...
estado = src_player_blue_andando;
estado2 = src_player_blue_atirando;
estado3 = src_player_blue_ativa_dash;
estado4 = src_player_blue_municao;
estado5 = src_player_blue_qtd_dash;
